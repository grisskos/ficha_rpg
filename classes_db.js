export const HABILIDADES_CLASSE = {
  ...
  "Especialista em Combate": [
    {
      ...
      tipo: "selecao_unica",
      opcoes: [
        { nome: "Estilo Defensivo", desc: "Você foca em aprimorar a sua defesa. Sua Defesa aumenta em 2 e, nos níveis 4, 8, 12 e 16 aumenta em +1." },
        { nome: "Estilo do Arremessador", desc: "Você se versa em armas de arremesso. Você pode sacar uma arma de arremesso como parte do ataque, além de receber +2 em rolagens de dano com elas, o qual aumenta em +1 nos níveis 4, 8, 12 e 16." },
        { nome: "Estilo do Duelista", desc: "Você foca em duelar com uma única arma em mãos. Ao usar uma arma em uma mão e ter a outra livre, você recebe +2 em rolagens de acerto e dano, o qual aumenta em +1 nos níveis 4, 8, 12 e 16." },
        { nome: "Estilo do Interceptador", desc: "Você se dedica a utilizar de suas armas para interceptar ataques em seus aliados. Quando um aliado dentro do seu alcance receber um ataque, você pode usar sua reação para reduzir o dano causado em 1d10 + seu modificador de força, destreza ou sabedoria, aumentando em um dado nos níveis 4, 8, 12 e 16." },
        { nome: "Estilo do Protetor", desc: "Você se dedica a proteger seus aliados, buscando evitar um acerto. Quando uma criatura ataca um alvo além de você, que esteja dentro de 1,5 metros, você pode usar sua reação para impor desvantagem. Além disso, você pode também conceder vantagem no Teste de Resistência de um aliado dentro de 1,5 metros." },
        { nome: "Estilo Distante", desc: "Você sabe como usar armas que focam em atingir de maneira distante. Você recebe +2 em rolagens de acerto e dano com armas a distância, o qual aumenta em +1 nos níveis 4, 8, 12 e 16." },
        { nome: "Estilo Duplo", desc: "Você sabe a maneira perfeita de manejar duas armas. Enquanto estiver lutando com duas armas, você pode adicionar o seu bônus de atributo no dano do ataque com a segunda arma, além de receber um bônus de +1 em rolagens de dano, o qual aumenta em +1 nos níveis 4, 8, 12 e 16." },
        { nome: "Estilo Massivo", desc: "Você domina armas pesadas e massivas. Quando rolar um 1 ou 2 em um dado na rolagem de dano com uma arma que esteja usando em duas mãos ou que possua a propriedade pesada, você pode rolar novamente esse dado, ficando com o novo resultado. Além disso, você recebe +1 em rolagens de dano com a arma, aumentando em +1 nos níveis 4, 8, 12 e 16." }
      ]
    },
    { 
      nivel: 1, 
    ...
    },
    {
      ...
      tipo: "selecao_unica",
      opcoes: ["Estilo Defensivo", "Estilo do Arremessador", "Estilo do Duelista", "Estilo do Interceptador", "Estilo do Protetor", "Estilo Distante", "Estilo Duplo", "Estilo Massivo"]
    },
    { 
      nivel: 6, 
  ...
  "Especialista em Técnica": [
    ...
    { 
      nivel: 6, 
      nome: "Feitiço Rápido", 
      desc: "Uma vez por rodada, quando for utilizar um Feitiço cuja conjuração seja uma Ação Completa ou Comum, você pode gastar PE para reduzir seu custo em ação em um (Completa para Comum ou Comum para Bônus). O custo é igual ao dobro do nível do Feitiço (considere 1 para Feitiços nível 0). Pré-Requisito: Nível 6." 
    },
    { 
      nivel: 9, 
      nome: "Teste de Resistência Mestre", 
    ...
    },
    {
      ...
      tipo: "selecao_unica",
      opcoes: [
        { nome: "Destruição", desc: "Todo Feitiço que você conjurar causa +1 de dano para cada dado rolado nela. Além disso, sempre que causar dano com um Feitiço ou aptidão amaldiçoada, você soma o seu bônus de treinamento no total de dano." },
        { nome: "Economia", desc: "O custo de todos os seus Feitiços é reduzido em 2, podendo reduzir o custo dos Feitiços nível 1 para 0. Além disso, você passa a somar o seu bônus de treinamento no seu máximo de energia amaldiçoada." },
        { nome: "Refino", desc: "Você recebe uma Aptidão Amaldiçoada ou Feitiço adicional a sua escolha. Além disso, você passa a somar metade do seu bônus de treinamento no cálculo de todas as suas CDs e em jogadas de ataque amaldiçoado." }
      ]
    },
    {
      nivel: 12,
  ...
  "Controlador": [
    ...
    { 
      ...
      desc: "Você é naturalmente mais capaz em comandar invocações, aprimorando o desempenho delas. Suas invocações recebem um bônus em testes que realizarem igual a +2, aumentando em +1 para cada grau acima do quarto (+3 para terceiro, +4 para segundo etc.)" 
    },
    {
      nivel: 6,
  ...
  "Suporte": [
    ...
    { 
      nivel: 6, 
      nome: "Aptidão: Energia Reversa", 
      desc: "Você recebe a aptidão amaldiçoada 'Energia Reversa'." 
    },
    { 
      nivel: 8, 
      nome: "Aptidão: Liberação de Energia Reversa", 
      desc: "Você recebe a aptidão amaldiçoada 'Liberação de Energia Reversa'." 
    },
    { 
      nivel: 9, 
      nome: "Teste de Resistência Mestre", 
  ...
  "Restringido": [
    ...
    { 
      ...
      desc: "Você recebe +1 em sua Defesa e em rolagens de Reflexos. No nível 9 e no nível 16, esse bônus aumenta em +1. Além disso, a partir do 10° nível, você se torna mestre no TR de Reflexos e o valor necessário para obter um sucesso crítico nela reduz em um valor igual a metade do seu bônus de treinamento." 
    },
    { 
      nivel: 4, 
