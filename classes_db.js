const HABILIDADES_CLASSE = {
  ...
  "Especialista em Técnica": [
    ...
    { nivel: 6, nome: "Feitiço Rápido", desc: "Uma vez por rodada, quando for utilizar um Feitiço cuja conjuração seja uma Ação Completa ou Comum, você pode gastar PE para reduzir seu custo em ação em um (Completa para Comum ou Comum para Bônus). O custo é igual ao dobro do nível do Feitiço (considere 1 para Feitiços nível 0). Pré-Requisito: Nível 6." },
    { nivel: 9, nome: "Teste de Resistência Mestre", desc: "Você se torna treinado em um segundo teste de resistência e mestre no concedido pela sua especialização." },
    {
      nivel: 10,
